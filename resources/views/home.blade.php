...
<div  class="container mt30">
		...
		@if (!Route::is('category',$item->category))
		<div  class="slider-row">

		<div id="demo" class="carousel slide" data-ride="carousel">
			<ul class="carousel-indicators">
				@foreach ($slide as $key => $open )
				<li data-target="#demo" data-slide-to="{{$open->id}}" class="@if($open->first)active @endif"></li>
				@endforeach
			</ul>
			<div class="carousel-inner">
					@foreach ($slide as $key => $open )
			    <div class="carousel-item @if($key==0)active @endif">
						<a href="#"><img  src="/images/Slider_Images/{{$open->image_name}}"  class="img-fluid"></a>
...
{{-- 
		<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
						@foreach ($slide->take(3) as $slide )
						<div class="carousel-item @if($loop->first)active @endif">
							<img class="d-block w-100" src="/images/Slider_Images/{{$slide->image_name}}" alt="First slide">
						</div>
						@endforeach
				</div>
