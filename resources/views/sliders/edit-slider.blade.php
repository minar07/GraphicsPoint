            ...
            <div class="container ">
                <div class="row">
                    <div class="col-sm-6">
						...
						<tr>
                            <td><a href="#"><img style="width:60%" src="/storage/slider_images/{{$slide->image_name_1}}" alt="" class="img-fluid"></a></td>
                            <td><a href="#"><img style="width:60%" src="/storage/slider_images/{{$slide->image_name_2}}" alt="" class="img-fluid"></a></td>
                            <td><a href="#"><img style="width:60%" src="/storage/slider_images/{{$slide->image_name_3}}" alt="" class="img-fluid"></a></td>
						</td>
                ...
                <div class="row">
					<div class="col-sm-6">
							<!-- column 2, content goes here... -->
									{{-- {!! Form::open(['action' => ['url' => route=[('sliders.update'), $slide->id], 'method'=> 'post', 'enctype'=>'multipart/form-data','files'=>true]) !!}							 --}}
                        <form action="{{ route('sliders.update',$slide->id) }}" method="POST" enctype="multipart/form-data" files="true">
								...
								<div class="form-group">
									...
									<input type="file" class="form-control" id="slider-image1" name="slider_image_one" placeholder="Enter Project Description">
								</div>
								<div class="form-group">
									<label for="slider_image_two">Slider Image Two</label>
									<input type="file" class="form-control" id="slider-image2" name="slider_image_two" placeholder="Enter Project Description">
								</div> 
								<div class="form-group">
									<label for="slider_image_three">Slider Image Three</label>
									<input type="file" class="form-control" id="slider-image3" name="slider_image_three" placeholder="Enter Project Description">
								</div>
